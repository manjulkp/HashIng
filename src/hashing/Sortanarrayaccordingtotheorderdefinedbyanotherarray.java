...
public class Sortanarrayaccordingtotheorderdefinedbyanotherarray {
...
// of A2[i] in temp 
			int f = search(temp, 0, m - 1, A2[i], m);
...
// not present in A2[] 
	...
	public static int search(int[] arr, int low, int high, int x, int n) {
		if (high >= low) {
			/* (low + high)/2; */
